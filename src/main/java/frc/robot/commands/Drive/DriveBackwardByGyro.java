...
public class DriveBackwardByGyro extends CommandBase {
  ...
  public DriveBackwardByGyro(double distance, double speed) {
  ...
  public void end(boolean interrupted) {
    ...
    System.out.println(" > DriveBackwardByGyro() ended!");
